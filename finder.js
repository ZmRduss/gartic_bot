...
<div class="text"><i class="cz flag"></i>Čeština</div>
<div class="menu">
...
<div class="item" data-value="15"><i class="jp flag"></i>日本語</div>
	...
	<div class="field">
    <button class="ui pink right labeled icon button" id="search" ><i class="search icon"></i>Hledat</button>
    </div>
    </div>
    </div>
    ...
    <div class="field" id="name">
      ...
      <div class="ui large labeled input"><input type="text" value="${params.get('keyword') || "Kokot"}" placeholder="Jméno zmrda" maxlength="17" spellcheck="false" data-ms-editor="true"></div>
    </div>
    ...
    <input type="hidden" name="country">
    <div class="text"></i>Výchozí</div>
    <div class="menu">
    <div class="item" data-value="unknown">Výchozí</div>
    <div class="item" data-value="full">Celé jméno</div>
    <div class="item" data-value="partial">Část jména</div>
    </div>
    </div>
    </div>

    <div class="field">
    <label>Profilovka:</label>
    ...
    <div class="text"><img class="ui avatar image">Výchozí</div>
    <div class="menu transition hidden" tabindex="-1">
    <div data-value="unknown" class="item active selected">
          <img class="ui avatar image">Výchozí</div><div data-value="pictures" class="item">
          <img class="ui avatar image">Soukromá profilovka</div><div data-value="0" class="item">
    ...
    <div class="text"></i>Výchozí</div>
    <div class="menu">
    <div class="item" data-value="unknown"><i class="th list icon"></i>Výchozí</div>
    <div class="item" data-value="user"><i class="user icon"></i>Kokot</div>
    ...
    try {
        document.querySelector("#list").innerHTML = `
            <div class="ui active dimmer">
                <div class="ui large text loader">Hledám všechny kokoty v místnostech</div>
            </div>
            <div class="ui card">
    <div class="image">
...
function updatePlayerList() {
    ...
    if (params.get('name-type') === "full") {
        let keyword = params.get('keyword') || "kokot";
        ...
        card.addEventListener("click", async function (e) {
            if (e.target.tagName === "A") {
                ...
                iziToast.info({
                    ...
                    //theme: 'dark',
                    title: 'Zkopírováno',
                    message: `${item.roomcode} Kód místnosti byl zkopírován`
                });
            } else {
